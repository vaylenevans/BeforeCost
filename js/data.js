...
BC.PRICES = {
  mh_tmc: {
    vaginal_delivery: { cash:34969, disc:10956, fee:'Hospital only (estimated)' },
    cesarean:         { cash:49452, disc:15493, fee:'Hospital only (estimated)' },
    appendectomy:     { cash:77976, disc:24853, fee:'Both (estimated)' },
    breast_biopsy:    { cash:3129,  disc:null,  fee:'Hospital only (estimated)', note:'no_discount' },
    hysterectomy:     { cash:1650,  disc:1072,  fee:'Physician only (estimated)' },
    colonoscopy:      { cash:1620,  disc:1620,  fee:'Hospital only (estimated)', note:'no_discount' },
    cholecystectomy:  { cash:83337, disc:26574, fee:'Both (estimated)' },
    ct_abdomen:       { cash:407,   disc:265,   fee:'Physician only (estimated)' },
    mri_lumbar:       { note:'suppressed' },
    tonsillectomy:    { cash:550,   disc:357,   fee:'Physician only (estimated)', note:'age_under_12' },
    hernia:           { cash:25645, disc:25645, fee:'Hospital only (estimated)', note:'no_discount' }
  },
  mh_southwest: {
    vaginal_delivery: { cash:27435, disc:8595,  fee:'Hospital only (estimated)' },
    cesarean:         { cash:39754, disc:12455, fee:'Hospital only (estimated)' },
    appendectomy:     { cash:38262, disc:12410, fee:'Both (estimated)' },
    breast_biopsy:    { cash:2723,  disc:2723,  fee:'Hospital only (estimated)', note:'no_discount' },
    hysterectomy:     { cash:1650,  disc:1072,  fee:'Physician only (estimated)' },
    colonoscopy:      { cash:1543,  disc:1543,  fee:'Hospital only (estimated)', note:'no_discount' },
    cholecystectomy:  { cash:44008, disc:14251, fee:'Both (estimated)' },
    ct_abdomen:       { cash:5473,  disc:1850,  fee:'Both (estimated)' },
    mri_lumbar:       { note:'suppressed' },
    tonsillectomy:    { cash:7249,  disc:7249,  fee:'Hospital only (estimated)', note:'age_under_12' },
    hernia:           { cash:28854, disc:9408,  fee:'Both (estimated)' }
  },
  mh_heights: {
    vaginal_delivery: { cash:26939, disc:8440,  fee:'Hospital only (estimated)' },
    cesarean:         { cash:37850, disc:11858, fee:'Hospital only (estimated)' },
    appendectomy:     { cash:44857, disc:14477, fee:'Both (estimated)' },
    breast_biopsy:    { cash:10554, disc:3415,  fee:'Both (estimated)' },
    hysterectomy:     { cash:1650,  disc:1072,  fee:'Physician only (estimated)' },
    colonoscopy:      { cash:1543,  disc:1543,  fee:'Hospital only (estimated)', note:'no_discount' },
    cholecystectomy:  { cash:38309, disc:12466, fee:'Both (estimated)' },
    ct_abdomen:       { cash:407,   disc:265,   fee:'Physician only (estimated)' },
    mri_lumbar:       { note:'suppressed' },
    tonsillectomy:    { cash:550,   disc:192,   fee:'Physician only (estimated)', note:'age_under_12' },
    hernia:           { cash:11816, disc:11816, fee:'Hospital only (estimated)', note:'no_discount' }
  },
  methodist_tmc: {
    vaginal_delivery: { cash:30680, disc:15187, fee:'Hospital only (estimated)' },
    cesarean:         { cash:37462, disc:18544, fee:'Hospital only (estimated)' },
    appendectomy:     { cash:57356, disc:28391, fee:'Hospital only (estimated)' },
    breast_biopsy:    { cash:15435, disc:7640,  fee:'Hospital only (estimated)' },
    hysterectomy:     { cash:84398, disc:41777, fee:'Hospital only (estimated)' },
    colonoscopy:      { cash:644,   disc:644,   fee:'Hospital only (estimated)', note:'no_discount' },
    cholecystectomy:  { cash:54880, disc:27166, fee:'Hospital only (estimated)' },
    ct_abdomen:       { cash:5804,  disc:2873,  fee:'Hospital only (estimated)' },
    mri_lumbar:       { cash:2112,  disc:1045,  fee:'Hospital only (estimated)' },
    tonsillectomy:    { cash:31629, disc:15657, fee:'Hospital only (estimated)' },
    hernia:           { cash:19554, disc:10978, fee:'Both (estimated)' }
  },
  methodist_west: {
    vaginal_delivery: { cash:31124, disc:15406, fee:'Hospital only (estimated)' },
    cesarean:         { cash:33331, disc:16499, fee:'Hospital only (estimated)' },
    appendectomy:     { cash:53074, disc:26272, fee:'Hospital only (estimated)' },
    breast_biopsy:    { cash:26532, disc:13133, fee:'Hospital only (estimated)' },
    hysterectomy:     { cash:80107, disc:39653, fee:'Hospital only (estimated)' },
    colonoscopy:      { cash:1258,  disc:1258,  fee:'Hospital only (estimated)', note:'no_discount' },
    cholecystectomy:  { cash:55667, disc:27555, fee:'Hospital only (estimated)' },
    ct_abdomen:       { cash:5802,  disc:2872,  fee:'Hospital only (estimated)' },
    mri_lumbar:       { cash:2112,  disc:1045,  fee:'Hospital only (estimated)' },
    tonsillectomy:    { cash:36004, disc:17822, fee:'Hospital only (estimated)' },
    hernia:           { cash:15604, disc:7724,  fee:'Hospital only (estimated)' }
  },
  methodist_baytown: {
    vaginal_delivery: { cash:34287, disc:16972, fee:'Hospital only (estimated)' },
    cesarean:         { cash:44895, disc:22223, fee:'Hospital only (estimated)' },
    appendectomy:     { cash:63474, disc:31420, fee:'Hospital only (estimated)' },
    breast_biopsy:    { cash:26532, disc:13133, fee:'Hospital only (estimated)' },
    hysterectomy:     { cash:121226,disc:60007, fee:'Hospital only (estimated)' },
    colonoscopy:      { cash:1258,  disc:1258,  fee:'Hospital only (estimated)', note:'no_discount' },
    cholecystectomy:  { cash:70097, disc:34698, fee:'Hospital only (estimated)' },
    ct_abdomen:       { cash:5802,  disc:2872,  fee:'Hospital only (estimated)' },
    mri_lumbar:       { cash:2112,  disc:1045,  fee:'Hospital only (estimated)' },
    tonsillectomy:    { cash:35557, disc:17601, fee:'Hospital only (estimated)' },
    hernia:           { cash:18175, disc:10295, fee:'Both (estimated)' }
  },
  hca_clearlake: {
    vaginal_delivery: { low:15923, high:20665, fee:'Hospital only (estimated)' },
    cesarean:         { low:44703, high:59446, fee:'Hospital only (estimated)' },
    appendectomy:     { low:68246, high:86308, fee:'Hospital only (estimated)' },
    breast_biopsy:    { low:13665, high:15776, fee:'Hospital only (estimated)' },
    hysterectomy:     { low:84264, high:91610, fee:'Hospital only (estimated)' },
    colonoscopy:      { low:15137, high:23030, fee:'Hospital only (estimated)' },
    cholecystectomy:  { low:49056, high:57710, fee:'Hospital only (estimated)' },
    ct_abdomen:       { cash:5824, disc:5824,  fee:'Hospital only (estimated)', note:'no_discount' },
    mri_lumbar:       { cash:8876, disc:8876,  fee:'Hospital only (estimated)', note:'no_discount' },
    tonsillectomy:    { low:36216, high:48653, fee:'Hospital only (estimated)' },
    hernia:           { low:47627, high:61631, fee:'Hospital only (estimated)' }
  },
  stlukes_pmc: {
    vaginal_delivery: { note:'not_offered' },
    cesarean:         { note:'not_offered' },
    appendectomy:     { low:8180.96,  high:12271.44, fee:'Hospital only (estimated)' },
    breast_biopsy:    { low:3216.44,  high:4824.66,  fee:'Hospital only (estimated)' },
    hysterectomy:     { note:'not_offered' },
    colonoscopy:      { note:'not_offered' },
    cholecystectomy:  { low:26190.70, high:39286.04, fee:'Hospital only (estimated)' },
    ct_abdomen:       { note:'ct_contrast' },
    mri_lumbar:       { note:'not_offered' },
    tonsillectomy:    { low:4134.42,  high:6201.64,  fee:'Hospital only (estimated)' },
    hernia:           { low:6529.05,  high:9793.57,  fee:'Hospital only (estimated)' }
  }
};
